...
namespace V2 {
    ...
    [Preserve]
    public partial class TransitionPropertyFloat : IExtensible
    {
        public TransitionPropertyFloat() { }

        public TransitionPropertyFloat(float value, Transition transition = Transition.Constant)
        {
            this.value = value;
            this.transition = transition;
        }

        public static implicit operator float(TransitionPropertyFloat prop)
        {
            return prop.value;
        }

        public void Set(float rhs, Transition trans)
        {
            value = rhs;
            transition = trans;
        }

        public void Set(float rhs)
        {
            value = rhs;
        }

        public TransitionPropertyFloat Copy()
        {
            return new TransitionPropertyFloat(value, transition);
        }

        public static float LerpFloat(TransitionPropertyFloat a, TransitionPropertyFloat b, float t)
        {
            t = Mathf.Clamp01(t);
            return LerpFloatUnclamped(a, b, t);
        }

        public static float LerpFloatUnclamped(TransitionPropertyFloat a, TransitionPropertyFloat b, float t)
        {
            return TransitionLib.LerpUnclamped(a, b, t, a.transition);
        }

        public static TransitionPropertyFloat Lerp(TransitionPropertyFloat a, TransitionPropertyFloat b, float t)
        {
            t = Mathf.Clamp01(t);
            return LerpUnclamped(a, b, t);
        }

        public static TransitionPropertyFloat LerpUnclamped(TransitionPropertyFloat a, TransitionPropertyFloat b, float t)
        {
            return new TransitionPropertyFloat(TransitionLib.LerpUnclamped(a, b, t, a.transition), a.transition);
        }
    ...
    [Preserve]
    public partial class TransitionColor : IExtensible
    {
        public TransitionColor() { }
        public TransitionColor(int r, int g, int b, int a = 255, Transition transition = Transition.Constant)
        {
            this.r = r;
            this.g = g;
            this.b = b;
    ...
    [Preserve]
    public partial class TransitionVector : IExtensible
    {
        [JsonIgnore]
        ...
        {
            this.x = new TransitionPropertyFloat(x, transX);
            this.y = new TransitionPropertyFloat(y, transY);
        }
        ...
        public static Vector3 LerpVectorUnclamped(TransitionVector a, TransitionVector b, float t)
        {
            t = Math.Clamp01(t);
            return new Vector3(
                TransitionPropertyFloat.LerpFloatUnclamped(a.x, b.x, t),
                TransitionPropertyFloat.LerpFloatUnclamped(a.y, b.y, t),
        ...
        public static TransitionVector LerpUnclamped(TransitionVector a, TransitionVector b, float t)
        {
            return new TransitionVector
            {
                x = TransitionPropertyFloat.LerpUnclamped(a.x, b.x, t),
                y = TransitionPropertyFloat.LerpUnclamped(a.y, b.y, t),
